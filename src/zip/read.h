 ...
 */
void read_central_directory(ifstream &, struct central_directory *, unsigned int start_byte);
 ...
 * \param start_byte Byte where starts the Central Directory.
 */
void read_end_central_directory(ifstream &, struct end_central_directory *, unsigned int);
 ...
 */
void read_local_file_header(ifstream &, struct local_file_header_light *, bool);
